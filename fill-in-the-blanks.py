...
def load_fib_difficulty():
    """Asks for a difficulty level and loads that difficulty.
...
def provide_link(level):
    """ A link to the wizard of oz song.
...
def play_game():
    ...
    Displays the chosen difficulty. Game then ends with a printed
    youtube address of the wizard of oz song to enjoy.
    Args:
        none.
    Returns:
        none.
    ...
    print ("Congratulations and always follow the yellow brick road!")
